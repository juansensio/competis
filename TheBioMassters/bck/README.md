...
UNet temporal DF (S1 2 first bands, S2 RGBNirSwir+ndvi+ndwi+clouds) r34 -> 7902 / 30.4817 (tta 4)
UNet temporal DF (S1 2 first bands, S2 RGBNirSwir+ndvi+ndwi+clouds) r18 trans -> next
